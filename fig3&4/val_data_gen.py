...
## A large amount of data is generated with a wide range of conditions. If performance is good here, it will likely perform better on other data.
...
doa = [[15.23, 21.12, 24.74]] # k=2
doa = [[21.12, 24.74]]  # k=2
mc_num = 10000  # Number of Monte Carlo experiments
snapshots = [100, 200, 300, 400, 500, 1000, 1500, 2000]  # Number of snapshots
snrs = np.arange(-20, 5.1, 5)  # Signal-to-noise ratios for test data
save_dir = '/home/yxxie/Documents/mutli_cls_tran_cnn/fig3_performance/val_data'  # Save path
...
def get_data_conditions(snapshots, snrs, mc_num, doa):
    ...
    data_num = 1  # Assign unique identifiers to generated test data
